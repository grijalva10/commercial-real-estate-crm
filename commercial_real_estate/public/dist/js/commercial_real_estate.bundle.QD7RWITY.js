(() => {
  // ../commercial_real_estate/commercial_real_estate/public/js/custom_sidebar.js
  ...
  commercial_real_estate.custom_sidebar.render_sidebar_items = function(items) {
    ...
    const createGroup = (icon, label, color, is_collapsible) => {
      ...
      if (is_collapsible) {
        $title.on("click", (e) => {
          let icon2 = $(e.target).find("span use").attr("href") === "#icon-small-down" ? "#icon-right" : "#icon-small-down";
          $(e.target).find("span use").attr("href", icon2);
  ...
  // ../commercial_real_estate/commercial_real_estate/public/js/page.js
  ...
  frappe.ui.Page = class Page {
    ...
    add_main_section() {
      ...
      if (this.single_column) {
        this.add_view("main", '<div class="row layout-main">					<div class="col layout-main-section-wrapper">						<div class="layout-main-section"></div>						<div class="layout-footer hide"></div>					</div>				</div>');
      } else {
        this.add_view("main", `
				<div class="row layout-main">
					<div class="col-lg-2"><div class="layout-side-section"></div></div>
...
//# sourceMappingURL=commercial_real_estate.bundle.QD7RWITY.js.map
